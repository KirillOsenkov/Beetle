    ...
    private static async Task Main(string[] args)
    {
        ...
        builder.Services
            .AddMcpServer(options =>
            {
                ...
                // typos (e.g. `processNameFilter` vs `processNameRegex`) get
                // silently dropped and the LLM never learns it called the tool
                // wrong. See https://github.com/modelcontextprotocol/csharp-sdk/issues/1508.
